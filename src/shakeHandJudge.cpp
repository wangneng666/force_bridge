...
int main(int argc, char *argv[])
{
    ...
    //初始化服务与话题
    //设置最大距离，最小距离，握手摆动次数
    ros::ServiceServer bringUp_server = node.advertiseService("shakeHandJudge/bringUp", shakeHand_bringUpCB);
    //关闭握手服务
    ros::ServiceServer shutdown_server = node.advertiseService("shakeHandJudge/shutdown", shakeHand_shutDownCB);
